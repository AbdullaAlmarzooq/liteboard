...
const FilterBar = ({ onFilterChange, allTickets }) => {
  ...
  return (
    <div className="rounded-xl shadow-lg p-6 mb-8 flex flex-col md:flex-row gap-4 justify-start items-start bg-white dark:bg-gray-800 transition-colors duration-200">
