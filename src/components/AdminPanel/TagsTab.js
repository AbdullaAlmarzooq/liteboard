...
const TagsTab = ({ tags, editingItem, editForm, handleEdit, handleSave, handleCancel, handleInputChange, handleDelete }) => {
  if (tags.length === 0) {
  ...
  return (
    <div className="grid gap-4">
      {tags.map(tag => (
        <div key={tag.id} className="bg-white rounded-lg border border-gray-200 dark:border-gray-700 dark:bg-gray-800 p-4 shadow-sm">
